...
app.get("*", function(request, response) {
 response.render('about', {
   ...
   hideMenu: true,
   data: [{
     text: `Rachel is an educator and interdisciplinary media artist. She is currently an Adjunct Professor at NYU and works for Mouse, a youth development nonprofit that believes in technology as a force for good. Since 2014, Rachel has been a member of The Illuminator, a political projection collective based in NYC. She has an MFA in Integrated Media Arts from Hunter College (CUNY), and is an avid cyclist, yogi and wanderer. 
<br>
<br>
